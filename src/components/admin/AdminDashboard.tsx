  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 bg-[#050505] text-[#F5F5F5]">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
        ...
        {/* HERO BANNERS */}
        <div
          id="stat-total-banners"
          onClick={onNavigateToBanners}
          className="bg-[#0D0D0D] rounded-2xl p-6 border border-[#D4AF37]/25 hover:border-[#D4AF37]/60 shadow-md transition-all cursor-pointer col-span-2 lg:col-span-1 group"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold uppercase tracking-wider text-[#D4AF37]">
              Hero Banners
          ...
          <p className="mt-2 text-xs text-zinc-400 flex items-center space-x-1">
            <span>{banners.filter(b => b.isActive).length} active slides</span>
            <ArrowUpRight className="w-3.5 h-3.5 text-[#D4AF37]" />
          </p>
        </div>
      </div>
