          ...
          <div className="flex items-center space-x-2 cursor-pointer min-w-0" onClick={() => onNavigate('catalogue')}>
            ...
            <div className="flex flex-col justify-center min-w-0">
              <BrandName
                ...
                className="font-black text-[10px] min-[330px]:text-[11.5px] min-[360px]:text-[13px] sm:text-base tracking-[0.06em] min-[360px]:tracking-[0.12em] sm:tracking-[0.16em] leading-tight uppercase whitespace-nowrap shrink-0"
                spaceClass="ml-1 min-[330px]:ml-1.5 sm:ml-2"
              />
              {!isAdminView && (
